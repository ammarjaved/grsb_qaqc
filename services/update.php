...
//        $wkt=$_REQUEST['geom'];
        ...
        if($geom=='1') {
            ...
            $sql_dist = "UPDATE qaqc.poi_data1 SET  name='$poi', business_type='$bt', lot_no='$lot_no',street_name='$st_name', post_code='$p_code', state='$state', area_building_name_neighbourhood='$nh', city_name='$cn',alternative_name='$an',image_path='$img_path',grab_street='$gs',geom=ST_GeomFromText('$geom',4326) WHERE id='$id';";
