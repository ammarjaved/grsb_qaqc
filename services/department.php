...
class Pss extends connection
{
    ...
    public function get_data()
    {
        ...
        if($dept=='other'){
            $str=" where survey_data->>'user_mobile' not in ('03455449871','03454851515','03234555267','03139294494')";
        }else if($dept=='uu'){
            $str=" where survey_data->>'user_mobile' in ('03455449871','03454851515','03234555267','03139294494')";
...
survey_data->>'house_no' as house_no,survey_data->>'plot_size' as plot_size,
survey_data->>'landuse' as landuse,survey_data->>'house_progress' as house_progress,
survey_data->>'remarks' as remarks,survey_data->>'user_mobile' as phone_no,ST_SetSRID(ST_Point((survey_data->>'lng')::numeric, (survey_data->>'lat')::numeric), 4326) as geom
from tbl_survey_data_raw".$str."  ) as tbl1 ";
